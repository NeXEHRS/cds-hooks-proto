#### /order-sign/digoxin-cyclosporine-cds-sign
...
コンテキストパス
> {baseUrl} /order-sign/digoxin-cyclosporine-cds-sign

リクエストサンプル
```bash
curl --location 'http://example.com/order-sign/digoxin-cyclosporine-cds-sign' \
...
```bash
{
    "cards": [
        {
            "uuid": "d8799ea3-f9ea-4732-9dc8-ac6807e43d8a",
